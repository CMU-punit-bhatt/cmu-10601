...
\clearpage
    ...
    \checkboxchar{$\Box$} \checkedchar{$\blacksquare$}
        \CorrectChoice A negative 100\% grade on the assignment
...
\CorrectChoice Talk to the course staff early so they can point you to the available resources on campus and make necessary arrangements
...
\CorrectChoice Reach out to your advisor so that they are aware of the situation
\choice None of the above
\end{checkboxes}   
...
\begin{questions}
    ...
    \textbf{Select one:}
    \begin{checkboxes}{}
        \CorrectChoice $g: \mathcal{R}^n \rightarrow \mathcal{R}$
...
\begin{enumerate}
    ...
    \end{itemize}
    \item Did you find or come across code that implements any part of this assignment ? \\ No. (See below policy on “found code”)
    \begin{itemize}
        \item If you answered `yes', give full details: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
