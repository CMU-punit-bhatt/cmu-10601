...
if __name__ == '__main__':
    ...
    plt.plot(list(range(1, n_epochs + 1)), train_losses[0], 'ro-', label='Training')
    plt.plot(list(range(1, n_epochs + 1)), val_losses[0], 'bo-', label='Validation')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('LR = 0.1')
    plt.legend()
    ...
    plt.plot(list(range(1, n_epochs + 1)), train_losses[1], 'ro-', label='Training')
    plt.plot(list(range(1, n_epochs + 1)), val_losses[1], 'bo-', label='Validation')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('LR = 0.01')
    plt.legend()
    ...
    plt.plot(list(range(1, n_epochs + 1)), train_losses[2], 'ro-', label='Training')
    plt.plot(list(range(1, n_epochs + 1)), val_losses[2], 'bo-', label='Validation')
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.title('LR = 0.001')
    plt.legend()
